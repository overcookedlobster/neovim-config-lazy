...
function M.setup()
	...
	vim.keymap.set(
		...
		"<leader>cl",
		M.list_checklists,
		{ noremap = true, silent = true, desc = "checklist: List checklists" }
	)
	...
	vim.keymap.set(
		...
		"<leader>cg",
		M.generate_directory_structure,
		{ noremap = true, silent = true, desc = "checklist: Generate directory structure from checklist" }
	)
end
